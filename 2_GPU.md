...
| Ampere架构  |  RTX3090 24GB  |                 -                  |        Tesla A100 40GB         | Quadro RTX A6000 48GB |
...
|    NVIDIA    | CUDA核心/Tensor核心及数量 | 价格 |
| :----------: | :-----------------------: | :--: |
| RTX 3070 8G  |         GA104-300-A1，5888个          |      |
...
**对于30系显卡，int计算单元和fp32计算单元共用一个CUDA，类似FX系列的假8核心。因此使用fp32的CUDA核心为实际的一半，其CUDA数量不能和20系进行比较**
